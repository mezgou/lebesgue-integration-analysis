...
#solution()[
  ...
  *Случай №1*
  ...
  Если 1 встретилась в позиции $i < k$, то значении $f(x)$ и $f(y)$ станут одинаковыми, так как хвосты обоих чисел обнулятся
  ...
  *Мера Лебега-Стилтьеса*
  ...
  Можно заметить, что на $E$ наша $F(x)$ монотонная и неубываящая, также если подставить граничные точки то они все будут совпадать с пределом слева
